...
{
    char c;
    //TO DO: read a character from UART
    //TO DO: write the character back to UART
}

void Timer_ISR()
{
    //TO DO: print the counter value to VGA
    //TO DO: print to the 7-segment display
...
int main(void) {
  ...
  *(unsigned int*) AHB_7SEG_BASE = 0;                               //reset 7-segment display
    ...
    *(unsigned int*) (AHB_7SEG_BASE +0x0C)= 0;      
    while(1){
        //TO DO: Set GPIO read mode
        //TO DO: Read from switch
        //TO DO: Set GPIO write mode
        //TO DO: Write to the LEDs
    }
}
